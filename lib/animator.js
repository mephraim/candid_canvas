...
(function() {
   ...
   * @private
   * @constructor
   * @param {HTMLCanvasElement} canvas a canvas element that
   * the animator will attach itself to
   **/
  ...
  function _initCurrentScene(anim) {
     ...
     *
     * @param {Scene} scene (optional) a scene to be set as the current scene
  ...
  function _initForPlay(anim, options) {
    ...
    // or copy the entire scenes array if there
   ...
   * each tick of the animation. For each tick the animator needs
